<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
      <div class="sidebar-brand">
        <a href="index.html">Khana-Pina</a>
      </div>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="menu-header">470 Project</li>
      ...
      <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>Manage Items</span></a>
      <ul class="dropdown-menu">
        <li class="{{setActive(['admin.brand.*'])}}"><a class="nav-link" href="{{route("admin.brand.index")}}">Restaurent</a></li>
        <li class="{{setActive([
        'admin.products.*',
        'admin.products-image-gallery.*',
        'admin.products-variant.*',
        ...
        ])}}"><a class="nav-link" href="{{route("admin.products.index")}}">Food</a></li>
