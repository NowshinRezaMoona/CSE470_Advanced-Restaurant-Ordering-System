            ...
            <div class="col-xl-3 col-sm-7 col-md-6 col-lg-3">
                <div class="wsus__footer_content">
                    <a class="wsus__footer_2_logo" href="#">
                        <img src="{{asset('frontend/images/new_logo.png')}}" alt="logo" class="img-fluid"   style="width:150px; height: 110px;border-radius:60%; ">
                    </a>
                    <a class="action" href="callto:+01747104710"><i class="fas fa-phone-alt"></i>
                        +017470470470</a>
                    <a class="action" href="mailto:khanapina@gmail.com"><i class="far fa-envelope"></i>
                        khanapina@gmail.com</a>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="wsus__copyright d-flex justify-content-center">
                        <p>Copyright © 2024 Online Feriwala. All Rights Reserved.</p>
                    </div>
                </div>
            </div>
        </div>
