        ...
        <div class="row">
            ...
            <div class="col-xl-2 col-7 col-md-8 col-lg-2">
                <div class="wsus_logo_area">
                    <a class="wsus__header_logo" href="index.html"><img src="{{asset('frontend/images/new_logo.png')}}" alt="logo" class="img-fluid"   style="width:140px; height: 70px;border-radius:60%; ">
