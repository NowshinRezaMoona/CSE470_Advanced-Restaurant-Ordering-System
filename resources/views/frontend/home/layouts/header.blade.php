<header style="background-color: rgb(192, 31, 31);">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-2 col-7 col-md-8 col-lg-2">
                <div class="wsus_logo_area">
                    <img src="{{asset('frontend/images/khana-pina.png')}}" alt="logo" class="img-fluid" style="width:155px; height: 65px; border-radius:40%; border: 3px solid white; transform: scale(1.1);">
    ...
    <div class="wsus__mini_cart">
        ...
        <ul>
            ...
            <li>
                <div class="wsus__cart_img">
                    <a href="#"><img src="{{asset('images/pro9.jpg')}}" alt="product" class="img-fluid w-100"></a>
                    <a class="wsis__del_icon" href="#"><i class="fas fa-minus-circle"></i></a>
                </div>
                <div class="wsus__cart_text">
