<section id="wsus__flash_sell" class="wsus__flash_sell_2">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
                <div class="offer_time" style="background: url({{ asset('frontend/images/flash.png') }})">
                    <div class="wsus__flash_coundown">
                        <span class="end_text">Flash sale</span>
                        <div class="simply-countdown simply-countdown-one"></div> 
                        <a class="common_btn" href="{{ route('flash-sale') }}" style="color: white; background-color: red;">see more <i class="fas fa-caret-right"></i></a>
                ...
                <div class="wsus__product_item">
                    @if($product)
                        ...
                        <div class="wsus__product_details">
                            ...
                            @else
                                <a class="wsus__category" href="#">No Category</a>
                            @endif
                            ...
                            @endif
                            <a class="add_cart" href="#">View</a>
                        </div>
                    @else
                        <div class="wsus__product_item">
                            <span class="wsus__new">Unknown Type</span>
                            <p class="wsus__category">Product Not Found</p>
                        </div>
                    @endif
                </div>             
            </div>
